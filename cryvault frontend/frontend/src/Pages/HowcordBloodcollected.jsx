        ...
        <Box className="container" sx={{ margin: "0 !important", padding: "0 !important" }}>
          <Box className="breadcrumb-inner">
            <Box className="page-title d-flex align-items-center">
              <Box sx={{display: "flex", gap: "26rem", alignItems: "center", textAlign: isMobile ? " center" : "start ", width: "100% !important" }}>
                <Typography  sx={{ fontSize: isMobile ? "24px !important" : "25px !important",width:"none !important",fontWeight:"600" }} variant="h1" className="">
