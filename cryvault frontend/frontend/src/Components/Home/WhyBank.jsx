  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", position: "absolute", width: "100%" }}>
      ...
      <Box className="whybankContent">
        ...
        <Box columnSpacing={4} container spacing={4} xs={12} md={4} sm={4} sx={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "1rem", padding: isMobile ? "4rem 1rem" : "3rem 11rem", margin: "0 !important", flexGrow: 1, maxWidth: "100% !important" }}>
